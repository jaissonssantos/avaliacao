app
	.service('marketplaceEstabelecimentoService', ['$rootScope', '$timeout', '$http', 'Upload', function($rootScope, $timeout, $http, Upload) {
		...
		this.load = function(){
			...
			$http.post("/controller/gestor/configuracoes/getestabelecimento")
		...
		this.update = function(){
			...
			var $promise = Upload.upload({ url: "/controller/gestor/configuracoes/updateestabelecimento", data: self.estabelecimento });
