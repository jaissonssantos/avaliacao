angular.module('app').controller('relatorioStatusServicoProfissionalController', ['$rootScope', '$scope', '$routeParams', 'relatorioService', 'servicoService', 'profissionalService',
function($rootScope, $scope, $routeParams, relatorioService, servicoService, profissionalService) {
