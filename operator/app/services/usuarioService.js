app.service('usuarioService', ['$rootScope', '$timeout', '$http', function($rootScope, $timeout, $http) {
  ...
  this.getList = function(){
    $http.post('/controller/plataforma/usuario/list', self.usuario)
  ...
  this.load = function(){
    ...
    $http.post('/controller/plataforma/usuario/get', self.usuario)
  ...
  this.checkEmail = function(usuario){
    ...
    $http.post('/controller/plataforma/usuario/checkemail', usuario)
  ...
  this.checkLogin = function(usuario){
    ...
    $http.post('/controller/plataforma/usuario/checklogin', usuario)
    .success(function(response){
  ...
  this.changePassword = function(){
    ...
    $http.post('/controller/plataforma/usuario/changepassword', self.usuario)
    .success(function(response){
  ...
  this.save = function(){
    $http.post('/controller/plataforma/usuario/create', self.usuario)
    .success(function(response){
  ...
  this.update = function(){
    ...
    $http.post('/controller/plataforma/usuario/update', self.usuario)
    .success(function(response){
  ...
  this.setStatus = function(status){
    ...
    $http.post('/controller/plataforma/usuario/setstatus', data)
    .success(function(response){
