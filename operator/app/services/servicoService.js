app.service('servicoService', ['$rootScope', '$timeout', '$http', function($rootScope, $timeout, $http) {
  ...
  this.getList = function(){
    ...
    $http.post('/controller/plataforma/servico/list', self.servico)
  ...
  this.load = function(){
    ...
    $http.post('/controller/plataforma/servico/get', self.servico)
  ...
  this.save = function(){
    ...
    $http.post('/controller/plataforma/servico/create', self.servico)
  ...
  this.update = function(){
    ...
    $http.post('/controller/plataforma/servico/update', self.servico)
    .success(function(response){
  ...
  this.setStatus = function(status){
    ...
    $http.post('/controller/plataforma/servico/setstatus', data)
    .success(function(response){
