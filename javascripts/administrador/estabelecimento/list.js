...
$(document).ready(function(){
    ...
    function list(reload = false, search = undefined, status = 1){
        ...
        //list
        app.util.getjson({
            url : "/controller/administrador/estabelecimento/list",
            method : 'POST',
    ...
    $('button.btn-add').livequery('click',function(event){
        window.location.href = "/administrador/estabelecimento/add";
    });
    ...
    $('a#setStatus').livequery('click',function(event){
        ...
        //status
        app.util.getjson({
            url : "/controller/administrador/estabelecimento/setstatus",
            method : 'POST',
            contentType : "application/json",
            data: params,
            success: function(response){
