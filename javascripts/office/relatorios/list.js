...
$(document).ready(function(){
    ...
    function list(reload = false, search = undefined, status = 1){
        ...
        //list
        app.util.getjson({
            url : "/controller/office/relatorios/list",
            method : 'POST',
                ...
                for (var i=0;i<response.results.length;i++) {
                    ...
                    html += '<tr>'+
                                ...
                                '<td class="text-center">'+
                                    '<a href="/office/relatorios/questionario/'+ response.results[i].id +'" title="Relatório em tempo real"> <i class="icon-graph text-inverse m-r-10"></i> </a>'+
                                '</td>'+
                            '</tr>';
                }
