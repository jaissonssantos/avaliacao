...
try {
    ...
    $required = array('nome', 'login', 'email', 'senha', 'perfil');
    ...
    'INSERT INTO
		usuario(
			nome,login,email,senha,idestabelecimento,liberado,perfil,status,
			master,datacadastro
		) VALUES (
			:nome,:login,:email,:senha,:idestabelecimento,:liberado,:perfil,:status,:master,now()
		)');
