...
try {
    ...
    $allowedSearch = array('nomefantasia', 'razaosocial', 'email');
    ...
    $stmt = $oConexao->prepare(
        'SELECT
			e.hash,e.cnpjcpf,e.razaosocial,e.nomefantasia,e.sobre,e.email,e.telefonecomercial,e.cep,e.logradouro,e.numero,e.complemento,e.bairro,e.licencainicial,e.licencafinal,e.datacadastro,
