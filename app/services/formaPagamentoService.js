angular.module('app').service('formaPagamentoService', ['$rootScope', '$http', function($rootScope, $http) {
  ...
  this.getList = function(){
    $http.get('/controller/gestor/formapagamento/list')
  ...
  this.save = function(){
    $http.post('/controller/gestor/formapagamento/create', self.formapagamento)
